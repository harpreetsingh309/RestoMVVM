...
struct AlertMsg {
    ...
    static let alertFavAdded = "Restaurant successfully added to your favourite list"
    static let alertFavRemoved = "Restaurant removed from your favourite list"
    ...
    static let emptyFav = "You did not mark any restaurant favourite"
}
